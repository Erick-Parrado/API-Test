...
class  UserModel{
    static public function createUser($data){
        ...
        if($cantMail==0){
            $query = "INSERT INTO users(use_id, use_mail, use_pss, use_dateCreate, us_identifier, us_key, us_status) VALUES (NULL, :use_mail, :use_pss, :use_dateCreate, :use_identifier, :use_key, :use_status);";
            $status = "0";
            ...
            $statement -> bindParam(":use_dateCreate", $data["dateCreate"],PDO::PARAM_STR);
    ...
    static public function getUsers($parametro){
        ...
        $query ="SELECT use_id, use_mail,use_dateCretae FROM users";
